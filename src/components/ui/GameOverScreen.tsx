...
export const GameOverScreen: React.FC<GameOverScreenProps> = ({ 
  ...
  return (
    <div className="absolute inset-0 z-[60] bg-red-900/60 flex flex-col items-center justify-center font-pixel animate-in fade-in duration-500">
      <h1 className="text-7xl md:text-8xl text-white mb-2 drop-shadow-[4px_4px_0_#000] font-medium tracking-wide">
        你死了！
      </h1>
      ...
      <div className="flex flex-col gap-6 w-80 md:w-96">
        ...
        >
          <span className="text-white text-2xl drop-shadow-[2px_2px_0_#000]">標題畫面</span>
        </button>
      </div>
    </div>
  );
